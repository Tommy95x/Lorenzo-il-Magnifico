...
public class ControllerWaitingRoom {
	...
	public void fade() throws IOException{
		FileReader file = new FileReader("Lorenzo-il-Magnifico/src/client/gui/controllers/Images.txt");//creo il file da leggere
		...
		file = new FileReader("Lorenzo-il-Magnifico/src/client/gui/controllers/mom.txt");//creo il file da leggere
		fileReader = new BufferedReader(file);
